  ...
  return (
    <nav className="nav">
      ...
      <ul className="nav__list nav__list--hidden">
        ...
        <li onClick={toggleMenuVisibility} className="nav__item"><Link className="link nav__link nav__link--dark" to="/statistics"> <p className="nav__text">Statistics</p> </Link></li>
